...
const RBY: {[name: string]: SpeciesData} = {
  ...
  Alakazam: {
    types: ['Psychic'],
    bs: {hp: 55, at: 50, df: 5, sp: 140, sl: 135},
    weightkg: 48,
  },
  Arbok: {types: ['Poison', 'Dark'], bs: {hp: 69, at: 95, df: 75, sp: 80, sl: 65}, weightkg: 65},
  Arcanine: {
    types: ['Fire', 'Ground'],
    bs: {hp: 100, at: 110, df: 85, sp: 100, sl: 80},
    weightkg: 155,
  },
  Articuno: {
    types: ['Ice', 'Flying'],
    bs: {hp: 100, at: 85, df: 120, sp: 85, sl: 125},
    weightkg: 55.4,
  },
  Beedrill: {
    types: ['Bug', 'Poison'],
    bs: {hp: 65, at: 100, df: 40, sp: 85, sl: 45},
    weightkg: 29.5,
  },
  Bellsprout: {
    types: ['Grass', 'Poison'],
    bs: {hp: 50, at: 75, df: 30, sp: 40, sl: 70},
    weightkg: 4,
    nfe: true,
  },
  Blastoise: {
  ...
  Bulbasaur: {
    types: ['Grass', 'Poison'],
    bs: {hp: 45, at: 49, df: 40, sp: 45, sl: 65},
    weightkg: 6.9,
    nfe: true,
  },
  Butterfree: {
    types: ['Bug', 'Psychic'],
    bs: {hp: 60, at: 45, df: 50, sp: 80, sl: 80},
    weightkg: 32,
  },
  Caterpie: {
    types: ['Bug'],
    bs: {hp: 50, at: 40, df: 35, sp: 45, sl: 20},
    weightkg: 2.9,
    nfe: true,
  },
  Chansey: {
    types: ['Normal'],
    bs: {hp: 250, at: 1, df: 1, sp: 50, sl: 105},
    weightkg: 34.6,
  },
  Charizard: {
    types: ['Fire', 'Dragon'],
    bs: {hp: 78, at: 74, df: 78, sp: 100, sl: 85},
    weightkg: 90.5,
  },
  Charmander: {
    types: ['Fire'],
    bs: {hp: 39, at: 47, df: 43, sp: 65, sl: 50},
    weightkg: 8.5,
    nfe: true,
  },
  Charmeleon: {
    types: ['Fire'],
    bs: {hp: 58, at: 59, df: 58, sp: 80, sl: 65},
    weightkg: 19,
    nfe: true,
  },
  Clefable: {types: ['Normal'], bs: {hp: 110, at: 60, df: 80, sp: 60, sl: 85}, weightkg: 40},
  Clefairy: {
    types: ['Normal'],
    bs: {hp: 65, at: 40, df: 48, sp: 30, sl: 60},
    weightkg: 7.5,
    nfe: true,
  },
  Cloyster: {
    types: ['Water', 'Ice'],
    bs: {hp: 50, at: 95, df: 190, sp: 70, sl: 85},
    weightkg: 132.5,
  },
  Cubone: {
    types: ['Ground'],
  ...
  Dewgong: {
    types: ['Water', 'Ice'],
    bs: {hp: 110, at: 65, df: 80, sp: 70, sl: 95},
    weightkg: 120,
  },
  Diglett: {
    types: ['Ground'],
  ...
  Ditto: {types: ['Normal'], bs: {hp: 150, at: 1, df: 180, sp: 1, sl: 48}, weightkg: 4},
  Dodrio: {
    types: ['Normal', 'Flying'],
    bs: {hp: 85, at: 110, df: 70, sp: 120, sl: 60},
    weightkg: 85.2,
  },
  Doduo: {
    types: ['Normal', 'Flying'],
  ...
  Dragonair: {
    types: ['Dragon'],
    bs: {hp: 76, at: 99, df: 80, sp: 85, sl: 70},
    weightkg: 16.5,
    nfe: true,
  },
  Dragonite: {
  ...
  Dratini: {
    types: ['Dragon'],
    bs: {hp: 61, at: 84, df: 65, sp: 70, sl: 50},
    weightkg: 3.3,
    nfe: true,
  },
  Drowzee: {
  ...
  Dugtrio: {
    types: ['Ground'],
    bs: {hp: 30, at: 75, df: 45, sp: 150, sl: 70},
    weightkg: 33.3,
  },
  Eevee: {
    types: ['Normal'],
  ...
  Electabuzz: {
    types: ['Electric'],
    bs: {hp: 65, at: 95, df: 50, sp: 105, sl: 85},
    weightkg: 30,
  },
  Electrode: {
    types: ['Electric'],
    bs: {hp: 60, at: 70, df: 70, sp: 140, sl: 80},
    weightkg: 66.6,
  },
  Exeggcute: {
    types: ['Grass', 'Psychic'],
  ...
  'Farfetch\u2019d': {
    ...
    bs: {hp: 75, at: 93, df: 83, sp: 85, sl: 58},
    weightkg: 15,
  },
  Fearow: {
    types: ['Flying'],
    bs: {hp: 95, at: 65, df: 90, sp: 100, sl: 61},
    weightkg: 38,
  },
  Flareon: {types: ['Fire'], bs: {hp: 65, at: 130, df: 60, sp: 65, sl: 110}, weightkg: 25},
  Gastly: {
    types: ['Ghost', 'Poison'],
    bs: {hp: 30, at: 100, df: 30, sp: 80, sl: 100},
    weightkg: 0.1,
    nfe: true,
  },
  Gengar: {
    types: ['Ghost', 'Poison'],
    bs: {hp: 60, at: 130, df: 60, sp: 115, sl: 130},
    weightkg: 40.5,
  },
  Geodude: {
    types: ['Rock', 'Ground'],
    bs: {hp: 50, at: 80, df: 100, sp: 10, sl: 30},
    weightkg: 20,
    nfe: true,
  },
  Gloom: {
  ...
  Golbat: {
    types: ['Poison', 'Flying'],
    bs: {hp: 80, at: 110, df: 70, sp: 90, sl: 75},
    weightkg: 55,
  },
  Goldeen: {
    types: ['Water'],
  ...
  Golduck: {types: ['Water'], bs: {hp: 50, at: 52, df: 48, sp: 55, sl: 80}, weightkg: 76.6},
  Golem: {
    types: ['Rock', 'Ground'],
    bs: {hp: 85, at: 120, df: 140, sp: 40, sl: 55},
    weightkg: 300,
  },
  Graveler: {
    types: ['Rock', 'Ground'],
    bs: {hp: 60, at: 95, df: 115, sp: 60, sl: 45},
    weightkg: 105,
    nfe: true,
  },
  Grimer: {
  ...
  Growlithe: {
    types: ['Fire'],
    bs: {hp: 50, at: 65, df: 40, sp: 55, sl: 50},
    weightkg: 19,
    nfe: true,
  },
  Gyarados: {
    types: ['Water', 'Dragon'],
    bs: {hp: 100, at: 100, df: 70, sp: 80, sl: 100},
    weightkg: 235,
  },
  Haunter: {
    types: ['Ghost', 'Poison'],
    bs: {hp: 45, at: 115, df: 45, sp: 95, sl: 115},
    weightkg: 0.1,
    nfe: true,
  },
  Hitmonchan: {
    types: ['Fighting'],
    bs: {hp: 50, at: 35, df: 110, sp: 80, sl: 35},
    weightkg: 50.2,
  },
  Hitmonlee: {
    types: ['Fighting'],
    bs: {hp: 50, at: 150, df: 53, sp: 87, sl: 35},
    weightkg: 49.8,
  },
  Horsea: {
    types: ['Water'],
  ...
  Hypno: {
    types: ['Psychic', 'Dark'],
    bs: {hp: 90, at: 75, df: 70, sp: 65, sl: 115},
    weightkg: 75.6,
  },
  Ivysaur: {
    types: ['Grass', 'Poison'],
    bs: {hp: 60, at: 62, df: 53, sp: 60, sl: 80},
    weightkg: 13,
    nfe: true,
  },
  Jigglypuff: {
    types: ['Normal'],
    bs: {hp: 110, at: 40, df: 15, sp: 15, sl: 25},
    weightkg: 5.5,
    nfe: true,
  },
  Jolteon: {
  ...
  Jynx: {
    types: ['Ice', 'Psychic'],
    bs: {hp: 70, at: 50, df: 65, sp: 100, sl: 95},
    weightkg: 40.6,
  },
  Kabuto: {
    types: ['Rock', 'Water'],
    bs: {hp: 30, at: 100, df: 90, sp: 55, sl: 45},
    weightkg: 11.5,
    nfe: true,
  },
  Kabutops: {
    types: ['Rock', 'Water'],
    bs: {hp: 65, at: 120, df: 110, sp: 85, sl: 70},
    weightkg: 40.5,
  },
  Kadabra: {
    types: ['Psychic'],
  ...
  Kakuna: {
    types: ['Bug', 'Poison'],
    bs: {hp: 80, at: 25, df: 50, sp: 35, sl: 25},
    weightkg: 10,
    nfe: true,
  },
  Kangaskhan: {
    types: ['Normal'],
    bs: {hp: 125, at: 95, df: 90, sp: 90, sl: 40},
    weightkg: 80,
  },
  ...
  Lickitung: {
    types: ['Normal'],
    bs: {hp: 130, at: 60, df: 85, sp: 30, sl: 60},
    weightkg: 65.5,
  },
  Machamp: {
    types: ['Fighting'],
    bs: {hp: 110, at: 150, df: 90, sp: 55, sl: 65},
    weightkg: 130,
  },
  Machoke: {
    types: ['Fighting'],
    bs: {hp: 90, at: 110, df: 80, sp: 45, sl: 50},
    weightkg: 70.5,
    nfe: true,
  },
  Machop: {
    types: ['Fighting'],
    bs: {hp: 70, at: 85, df: 55, sp: 35, sl: 35},
    weightkg: 19.5,
    nfe: true,
  },
  Magikarp: {
    types: ['Water'],
    bs: {hp: 1, at: 1, df: 1, sp: 1, sl: 1},
    weightkg: 10,
    nfe: true,
  },
  Magmar: {
    types: ['Fire'],
    bs: {hp: 65, at: 95, df: 50, sp: 110, sl: 85},
    weightkg: 44.5,
  },
  Magnemite: {
    types: ['Electric'],
  ...
  Magneton: {
    types: ['Electric'],
    bs: {hp: 85, at: 60, df: 95, sp: 70, sl: 120},
    weightkg: 60,
  },
  Mankey: {
    types: ['Fighting'],
  ...
  Marowak: {types: ['Ground', 'Ghost'], bs: {hp: 60, at: 120, df: 120, sp: 75, sl: 50}, weightkg: 45},
  Meowth: {
    types: ['Normal'],
    bs: {hp: 45, at: 50, df: 40, sp: 95, sl: 40},
    weightkg: 4.2,
    nfe: true,
  },
  Metapod: {
    types: ['Bug'],
    bs: {hp: 80, at: 20, df: 55, sp: 30, sl: 25},
    weightkg: 9.9,
    nfe: true,
  },
  Mew: {
    types: ['Psychic'],
    bs: {hp: 110, at: 110, df: 110, sp: 110, sl: 110},
    weightkg: 4,
  },
  Mewtwo: {
    types: ['Psychic'],
    bs: {hp: 125, at: 90, df: 100, sp: 130, sl: 154},
    weightkg: 122,
  },
  Moltres: {
    types: ['Fire', 'Flying'],
    bs: {hp: 100, at: 120, df: 90, sp: 90, sl: 125},
    weightkg: 60,
  },
  'Mr. Mime': {
    types: ['Psychic', 'Fighting'],
    bs: {hp: 40, at: 85, df: 65, sp: 90, sl: 100},
    weightkg: 54.5,
  },
  Muk: {types: ['Poison'], bs: {hp: 125, at: 105, df: 80, sp: 40, sl: 65}, weightkg: 30},
  Nidoking: {
    types: ['Poison', 'Ground'],
    bs: {hp: 80, at: 105, df: 65, sp: 85, sl: 75},
    weightkg: 62,
  },
  Nidoqueen: {
    types: ['Poison', 'Ground'],
    bs: {hp: 100, at: 80, df: 90, sp: 75, sl: 75},
    weightkg: 60,
  },
  'Nidoran-F': {
    types: ['Poison'],
    bs: {hp: 60, at: 45, df: 50, sp: 40, sl: 40},
    weightkg: 7,
    nfe: true,
  },
  'Nidoran-M': {
  ...
  Nidorina: {
    types: ['Poison'],
    bs: {hp: 75, at: 60, df: 65, sp: 55, sl: 55},
    weightkg: 20,
    nfe: true,
  },
  Nidorino: {
  ...
  Ninetales: {
    types: ['Fire'],
    bs: {hp: 70, at: 70, df: 70, sp: 100, sl: 100},
    weightkg: 19.9,
  },
  Oddish: {
    types: ['Grass', 'Poison'],
  ...
  Omastar: {
    types: ['Rock', 'Water'],
    bs: {hp: 85, at: 65, df: 130, sp: 60, sl: 115},
    weightkg: 35,
  },
  Onix: {
    types: ['Rock', 'Dragon'],
    bs: {hp: 55, at: 45, df: 170, sp: 80, sl: 30},
    weightkg: 210,
  },
  Paras: {
    types: ['Bug', 'Grass'],
  ...
  Parasect: {
    types: ['Bug', 'Grass'],
    bs: {hp: 100, at: 130, df: 110, sp: 10, sl: 80},
    weightkg: 29.5,
  },
  Persian: {types: ['Normal'], bs: {hp: 70, at: 100, df: 60, sp: 130, sl: 65}, weightkg: 32},
  Pidgeot: {
    types: ['Normal', 'Flying'],
    bs: {hp: 80, at: 115, df: 60, sp: 110, sl: 70},
    weightkg: 39.5,
  },
  Pidgeotto: {
    types: ['Normal', 'Flying'],
    bs: {hp: 70, at: 70, df: 55, sp: 80, sl: 50},
    weightkg: 30,
    nfe: true,
  },
  Pidgey: {
  ...
  Poliwrath: {
    ...
    bs: {hp: 90, at: 105, df: 95, sp: 60, sl: 70},
    weightkg: 54,
  },
  Ponyta: {
    types: ['Fire'],
  ...
  Porygon: {
    ...
    bs: {hp: 85, at: 85, df: 85, sp: 85, sl: 85},
    weightkg: 36.5,
  },
  Primeape: {
    types: ['Fighting'],
    bs: {hp: 80, at: 115, df: 65, sp: 95, sl: 60},
    weightkg: 32,
  },
  Psyduck: {
    types: ['Water', 'Psychic'],
    bs: {hp: 90, at: 65, df: 80, sp: 85, sl: 50},
    weightkg: 19.6,
    nfe: true,
  },
  Raichu: {
    types: ['Electric'],
    bs: {hp: 60, at: 90, df: 45, sp: 130, sl: 90},
    weightkg: 30,
  },
  Rapidash: {types: ['Fire'], bs: {hp: 70, at: 110, df: 60, sp: 110, sl: 80}, weightkg: 95},
  Raticate: {
    types: ['Normal'],
    bs: {hp: 70, at: 85, df: 50, sp: 90, sl: 50},
    weightkg: 18.5,
  },
  Rattata: {
    types: ['Normal'],
  ...
  Rhydon: {
    types: ['Ground', 'Rock'],
    bs: {hp: 115, at: 130, df: 120, sp: 50, sl: 45},
    weightkg: 120,
  },
  Rhyhorn: {
    types: ['Ground', 'Rock'],
  ...
  Sandshrew: {
    types: ['Ground'],
    bs: {hp: 55, at: 80, df: 95, sp: 30, sl: 30},
    weightkg: 12,
    nfe: true,
  },
  Sandslash: {
    types: ['Ground'],
    bs: {hp: 80, at: 110, df: 115, sp: 60, sl: 55},
    weightkg: 29.5,
  },
  Scyther: {
    types: ['Bug', 'Flying'],
    bs: {hp: 75, at: 110, df: 80, sp: 105, sl: 55},
    weightkg: 56,
  },
  Seadra: {types: ['Water', 'Normal'], bs: {hp: 80, at: 110, df: 90, sp: 85, sl: 95}, weightkg: 25},
  Seaking: {types: ['Water'], bs: {hp: 80, at: 110, df: 65, sp: 65, sl: 80}, weightkg: 39},
  Seel: {
    types: ['Water'],
    bs: {hp: 65, at: 40, df: 55, sp: 45, sl: 70},
    weightkg: 90,
    nfe: true,
  },
  Shellder: {
  ...
  Slowbro: {
    types: ['Water', 'Psychic'],
    bs: {hp: 110, at: 70, df: 110, sp: 30, sl: 80},
    weightkg: 78.5,
  },
  Slowpoke: {
    types: ['Water', 'Psychic'],
  ...
  Snorlax: {
    types: ['Normal'],
    bs: {hp: 160, at: 110, df: 50, sp: 30, sl: 65},
    weightkg: 460,
  },
  Spearow: {
    types: ['Flying'],
    bs: {hp: 50, at: 30, df: 70, sp: 70, sl: 31},
    weightkg: 2,
    nfe: true,
  },
  Squirtle: {
    types: ['Water'],
    bs: {hp: 44, at: 48, df: 70, sp: 43, sl: 50},
    weightkg: 9,
    nfe: true,
  },
  Starmie: {
  ...
  Tangela: {
    types: ['Grass', 'Dark'],
    bs: {hp: 100, at: 75, df: 110, sp: 40, sl: 100},
    weightkg: 35,
  },
  Tauros: {
    types: ['Normal'],
    bs: {hp: 75, at: 110, df: 95, sp: 110, sl: 70},
    weightkg: 88.4,
  },
  Tentacool: {
    types: ['Water', 'Poison'],
    bs: {hp: 50, at: 40, df: 30, sp: 70, sl: 100},
    weightkg: 45.5,
    nfe: true,
  },
  Tentacruel: {
    types: ['Water', 'Poison'],
    bs: {hp: 90, at: 70, df: 60, sp: 100, sl: 120},
    weightkg: 55,
  },
  Vaporeon: {
    types: ['Water'],
  ...
  Venomoth: {
    types: ['Bug', 'Poison'],
    bs: {hp: 70, at: 90, df: 50, sp: 105, sl: 90},
    weightkg: 12.5,
  },
  Venonat: {
    types: ['Bug', 'Poison'],
  ...
  Venusaur: {
    types: ['Grass', 'Poison'],
    bs: {hp: 80, at: 82, df: 73, sp: 80, sl: 100},
    weightkg: 100,
  },
  Victreebel: {
    types: ['Grass', 'Poison'],
    bs: {hp: 80, at: 105, df: 60, sp: 90, sl: 100},
    weightkg: 15.5,
  },
  Vileplume: {
    types: ['Grass', 'Poison'],
    bs: {hp: 95, at: 105, df: 80, sp: 50, sl: 100},
    weightkg: 18.6,
  },
  Voltorb: {
    types: ['Electric'],
  ...
  Wartortle: {
    types: ['Water'],
    bs: {hp: 59, at: 63, df: 85, sp: 58, sl: 65},
    weightkg: 22.5,
    nfe: true,
  },
  Weedle: {
    types: ['Bug', 'Poison'],
    bs: {hp: 40, at: 45, df: 30, sp: 50, sl: 20},
    weightkg: 3.2,
    nfe: true,
  },
  Weepinbell: {
    types: ['Grass', 'Poison'],
    bs: {hp: 65, at: 90, df: 45, sp: 55, sl: 85},
    weightkg: 6.4,
    nfe: true,
  },
  Weezing: {
    types: ['Poison', 'Dark'],
    bs: {hp: 65, at: 80, df: 120, sp: 50, sl: 85},
    weightkg: 9.5,
  },
  Wigglytuff: {
    types: ['Normal'],
    bs: {hp: 150, at: 90, df: 65, sp: 30, sl: 50},
    weightkg: 12,
  },
  Zapdos: {
    types: ['Electric', 'Flying'],
    bs: {hp: 100, at: 90, df: 85, sp: 120, sl: 125},
    weightkg: 52.6,
  },
  Zubat: {
    types: ['Poison', 'Flying'],
    bs: {hp: 40, at: 55, df: 30, sp: 60, sl: 40},
    weightkg: 7.5,
    nfe: true,
  },
};
...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Alakazam: {bs: {sa: 160, sd: 90}},
  Arbok: {bs: {sa: 55, sd: 80}},
  Arcanine: {bs: {sa: 120, sd: 85}},
  Articuno: {bs: {sa: 95, sd: 145}, gender: 'N'},
  Beedrill: {bs: {sa: 45, sd: 80}},
  Bellsprout: {bs: {sa: 75, sd: 30}},
  Blastoise: {bs: {sa: 85, sd: 95}},
  Bulbasaur: {bs: {sa: 65, sd: 70}},
  Butterfree: {bs: {sa: 100, sd: 80}},
  Caterpie: {bs: {sa: 20, sd: 20}},
  Chansey: {bs: {sa: 1, sd: 110}, nfe: true},
  Charizard: {bs: {sa: 119, sd: 85}},
  Charmander: {bs: {sa: 65, sd: 50}},
  Charmeleon: {bs: {sa: 85, sd: 65}},
  Clefable: {bs: {sa: 90, sd: 100}},
  Clefairy: {bs: {sa: 55, sd: 60}},
  Cloyster: {bs: {sa: 85, sd: 40}},
  Cubone: {bs: {sa: 40, sd: 50}},
  Dewgong: {bs: {sa: 70, sd: 100}},
  Diglett: {bs: {sa: 35, sd: 45}},
  Ditto: {bs: {sa: 1, sd: 180}, gender: 'N'},
  Dodrio: {bs: {sa: 50, sd: 60}},
  Doduo: {bs: {sa: 35, sd: 35}},
  Dragonair: {bs: {sa: 85, sd: 85}},
  Dragonite: {bs: {sa: 100, sd: 100}},
  Dratini: {bs: {sa: 70, sd: 70}},
  Drowzee: {bs: {sa: 43, sd: 90}},
  Dugtrio: {bs: {sa: 45, sd: 65}},
  Eevee: {bs: {sa: 45, sd: 65}},
  Ekans: {bs: {sa: 40, sd: 54}},
  Electabuzz: {bs: {sa: 100, sd: 85}},
  Electrode: {bs: {sa: 80, sd: 80}, gender: 'N'},
  Exeggcute: {bs: {sa: 60, sd: 45}},
  Exeggutor: {bs: {sa: 125, sd: 65}},
  'Farfetch\u2019d': {bs: {sa: 81, sd: 83}},
  Fearow: {bs: {sa: 60, sd: 70}},
  Flareon: {bs: {sa: 95, sd: 110}},
  Gastly: {bs: {sa: 35, sd: 35}},
  Gengar: {bs: {sa: 65, sd: 75}},
  Geodude: {bs: {sa: 30, sd: 30}},
  Gloom: {bs: {sa: 85, sd: 75}},
  Golbat: {bs: {sa: 65, sd: 75}, nfe: true},
  Goldeen: {bs: {sa: 35, sd: 50}},
  Golduck: {bs: {sa: 65, sd: 50}},
  Golem: {bs: {sa: 40, sd: 80}},
  Graveler: {bs: {sa: 45, sd: 45}},
  Grimer: {bs: {sa: 40, sd: 50}},
  Growlithe: {bs: {sa: 65, sd: 45}},
  Gyarados: {bs: {sa: 90, sd: 100}},
  Haunter: {bs: {sa: 50, sd: 55}},
  Hitmonchan: {bs: {sa: 130, sd: 80}},
  Hitmonlee: {bs: {sa: 35, sd: 110}},
  Horsea: {bs: {sa: 70, sd: 25}},
  Hypno: {bs: {sa: 73, sd: 115}},
  Ivysaur: {bs: {sa: 80, sd: 90}},
  Jigglypuff: {bs: {sa: 40, sd: 20}},
  Jolteon: {bs: {sa: 110, sd: 95}},
  Jynx: {bs: {sa: 120, sd: 95}},
  Kabuto: {bs: {sa: 55, sd: 45}},
  Kabutops: {bs: {sa: 70, sd: 75}},
  Kadabra: {bs: {sa: 120, sd: 70}},
  Kakuna: {bs: {sa: 25, sd: 25}},
  Kangaskhan: {bs: {sa: 10, sd: 90}},
  Kingler: {bs: {sa: 100, sd: 50}},
  Koffing: {bs: {sa: 60, sd: 45}},
  Krabby: {bs: {sa: 25, sd: 25}},
  Lapras: {bs: {sa: 85, sd: 95}},
  Lickitung: {bs: {sa: 80, sd: 85}},
  Machamp: {bs: {sa: 50, sd: 60}},
  Machoke: {bs: {sa: 40, sd: 40}},
  Machop: {bs: {sa: 30, sd: 30}},
  Magikarp: {bs: {sa: 1, sd: 1}},
  Magmar: {bs: {sa: 100, sd: 80}},
  ...
  Meowth: {bs: {sa: 45, sd: 45}},
  Metapod: {bs: {sa: 25, sd: 25}},
  Mew: {bs: {sa: 110, sd: 110}, gender: 'N'},
  Mewtwo: {bs: {sa: 155, sd: 100}, gender: 'N'},
  Moltres: {bs: {sa: 145, sd: 85}, gender: 'N'},
  'Mr. Mime': {bs: {sa: 100, sd: 120}},
  Muk: {bs: {sa: 50, sd: 100}},
  Nidoking: {bs: {sa: 105, sd: 65}},
  Nidoqueen: {bs: {sa: 70, sd: 90}},
  'Nidoran-F': {bs: {sa: 40, sd: 40}},
  'Nidoran-M': {bs: {sa: 40, sd: 40}},
  Nidorina: {bs: {sa: 55, sd: 55}},
  Nidorino: {bs: {sa: 55, sd: 55}},
  Ninetales: {bs: {sa: 80, sd: 125}},
  Oddish: {bs: {sa: 75, sd: 65}},
  Omanyte: {bs: {sa: 90, sd: 55}},
  Omastar: {bs: {sa: 120, sd: 65}},
  Onix: {bs: {sa: 20, sd: 170}, nfe: true},
  Paras: {bs: {sa: 45, sd: 55}},
  Parasect: {bs: {sa: 60, sd: 110}},
  Persian: {bs: {sa: 70, sd: 60}},
  Pidgeot: {bs: {sa: 60, sd: 60}},
  Pidgeotto: {bs: {sa: 50, sd: 50}},
  Pidgey: {bs: {sa: 35, sd: 35}},
  Pikachu: {bs: {sa: 50, sd: 40}},
  Pinsir: {bs: {sa: 50, sd: 75}},
  Poliwag: {bs: {sa: 40, sd: 40}},
  Poliwhirl: {bs: {sa: 50, sd: 50}},
  Poliwrath: {bs: {sa: 70, sd: 100}},
  Ponyta: {bs: {sa: 65, sd: 65}},
  Porygon: {bs: {sa: 85, sd: 85}, nfe: true, gender: 'N'},
  Primeape: {bs: {sa: 60, sd: 65}},
  Psyduck: {bs: {sa: 100, sd: 80}},
  Raichu: {bs: {sa: 90, sd: 70}},
  Rapidash: {bs: {sa: 110, sd: 60}},
  Raticate: {bs: {sa: 50, sd: 80}},
  Rattata: {bs: {sa: 25, sd: 35}},
  Rhydon: {bs: {sa: 40, sd: 65}},
  Rhyhorn: {bs: {sa: 30, sd: 30}},
  Sandshrew: {bs: {sa: 20, sd: 20}},
  Sandslash: {bs: {sa: 45, sd: 40}},
  Scyther: {bs: {sa: 50, sd: 80}, nfe: true},
  Seadra: {bs: {sa: 110, sd: 45}, nfe: true},
  Seaking: {bs: {sa: 65, sd: 80}},
  Seel: {bs: {sa: 50, sd: 70}},
  Shellder: {bs: {sa: 45, sd: 25}},
  Slowbro: {bs: {sa: 100, sd: 80}},
  Slowpoke: {bs: {sa: 40, sd: 40}},
  Snorlax: {bs: {sa: 60, sd: 130}},
  Spearow: {bs: {sa: 31, sd: 31}},
  Squirtle: {bs: {sa: 50, sd: 59}},
  Starmie: {bs: {sa: 100, sd: 85}, gender: 'N'},
  Staryu: {bs: {sa: 70, sd: 55}, gender: 'N'},
  Tangela: {bs: {sa: 100, sd: 75}},
  Tauros: {bs: {sa: 30, sd: 80}},
  Tentacool: {bs: {sa: 40, sd: 105}},
  Tentacruel: {bs: {sa: 70, sd: 125}},
  Vaporeon: {bs: {sa: 110, sd: 95}},
  Venomoth: {bs: {sa: 120, sd: 75}},
  Venonat: {bs: {sa: 40, sd: 55}},
  Venusaur: {bs: {sa: 100, sd: 110}},
  Victreebel: {bs: {sa: 105, sd: 60}},
  Vileplume: {bs: {sa: 100, sd: 80}},
  Voltorb: {bs: {sa: 55, sd: 55}, gender: 'N'},
  Vulpix: {bs: {sa: 50, sd: 65}},
  Wartortle: {bs: {sa: 65, sd: 75}},
  Weedle: {bs: {sa: 20, sd: 20}},
  Weepinbell: {bs: {sa: 90, sd: 45}},
  Weezing: {bs: {sa: 85, sd: 90}},
  Wigglytuff: {bs: {sa: 95, sd: 65}},
  Zapdos: {bs: {sa: 145, sd: 90}, gender: 'N'},
